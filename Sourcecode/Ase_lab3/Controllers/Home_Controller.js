(function () 
 {
        ...
        $scope.getReviews = function (venueSelected) {
            if (venueSelected != null) {
                ...
                var handler = $http.get("https://api.foursquare.com/v2/venues/" + venueSelected.id + "/tips" +
                    "?sort=recent" +
                    "&client_id=RO3OO3WZ4RMUI40AHPTVIU4NTJD5BUDM2WVHP4WY4AZ5YMIC" +
                    "&client_secret=GEGDYPMQOY01YXJ22ULMBVKMKHYXWY1MDFO5EG2THMMVFXZL&v=20160215" +
                    "&limit=5");
    ...
    Mashup.$inject = ['$scope', '$http'];
    angular.module('Naren').controller('Home_Controller', Mashup);
